...
AV_EXPECTED_BUCKET_KEY = os.getenv("AV_EXPECTED_BUCKET_KEY")
AV_EXPECTED_BUCKET_KEY_STATUS = os.getenv("AV_EXPECTED_BUCKET_KEY_STATUS", "av-expected-key-status")
AV_SCAN_BUCKET = os.getenv("AV_SCAN_BUCKET", "av-scan-bucket")
